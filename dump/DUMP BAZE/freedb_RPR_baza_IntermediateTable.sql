...
--
-- Table structure for table `IntermediateTable`
--
...
CREATE TABLE `IntermediateTable` (
  ...
  CONSTRAINT `onlineOrder_Id` FOREIGN KEY (`onlineOrder_Id`) REFERENCES `OnlineOrder` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `IntermediateTable`
--

LOCK TABLES `IntermediateTable` WRITE;
/*!40000 ALTER TABLE `IntermediateTable` DISABLE KEYS */;
/*!40000 ALTER TABLE `IntermediateTable` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-02-16 15:04:38
